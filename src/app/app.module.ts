...
import { PrizeBannerComponent } from './prize-board/prize-banner/prize-banner.component';

@NgModule({
  imports: [BrowserModule, Ng2OdometerModule.forRoot()],
  declarations: [
    AppComponent, BlockComponent, GameBoardComponent, TimesPipe, RollAreaComponent,FireworksComponent,PrizeBoardComponent,PrizeComponent, PrizeBannerComponent
  ],
